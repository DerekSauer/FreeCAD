...
void View3DSettings::OnChange(ParameterGrp::SubjectType& rCaller, ParameterGrp::MessageType Reason)
{
    ...
    if (strcmp(Reason, "EnableHeadlight") == 0) {
        ...
        unsigned long backlight =
            rGrp.GetUnsigned("AxisLetterColor", 0x00000000);  // default color (black)
        float transparency;
        SbColor color;
        ...
        for (auto _viewer : _viewers) {
            ...
            if (!rGrp.GetBool("UseBackgroundColorMid", false)) {
                _viewer->setGradientBackgroundColor(QColor::fromRgbF(r2, g2, b2),
                                                    QColor::fromRgbF(r3, g3, b3));
            }
            else {
                _viewer->setGradientBackgroundColor(QColor::fromRgbF(r2, g2, b2),
                                                    QColor::fromRgbF(r3, g3, b3),
                                                    QColor::fromRgbF(r4, g4, b4));
            }
        }
    }
}
